...
PROMPT = (
    ...
    f"1. Confirm that the dialogue currently visible on the screen (marked as **The Conversation Currently on Screen**) qualifies as testimony—that is, it is displayed in color=#00f000 and the \"Current State\" includes **Cross-Examination!**.\n"
