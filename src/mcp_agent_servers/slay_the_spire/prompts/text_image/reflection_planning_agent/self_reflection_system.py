...
PROMPT = (
    f"You are a strategic player for the game 'Slay The Spire'. Your role is to evaluate the success of actions based on state changes and provide logical reasoning.\n"
    ...
    f"Guidelines:\n"
    f"- If there were no playable cards, the turn would have ended automatically.\n"
