...
def main():
    root_dir = "./src/mcp_game_servers/pokemon_red/game/pokered"
    ...
    output_dir = os.path.join(os.path.join(os.getcwd(), "src", "mcp_game_servers", "pokemon_red", "game"), "processed_map")
