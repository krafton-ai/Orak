# IMPORTANT:
# Running this script directly does not work.
# Modify scripts/play_slay_the_spire.bat following below configuration, and run Slay the Spire game will read this script.
# Refer to docs/slay_the_spire_setup.md for more details.
