...
# This script is executed directly by the game launcher.
# For more details, see docs/slay_the_spire_setup.md.
...
source /Users/minkyu/miniforge3/etc/profile.d/conda.sh
conda activate gaming_slm
cd ~/Workspace/gamingslm
